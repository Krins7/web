...
class InvoiceForm extends React.Component {
  ...
  handleCalculateTotal() {
    ...
    const taxAmmount = parseFloat(subTotal) * (parseFloat(this.state.taxRate) / 100 || 0);
    const discountAmmount = parseFloat(subTotal) * (parseFloat(this.state.discountRate) / 100 || 0);
